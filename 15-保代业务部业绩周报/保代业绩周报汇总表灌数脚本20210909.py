...
alter table dmf_bi.dmfbi_profits_finance_rpt_sum_s_d drop partition (dt='{TX_DATE}',sys_src_code='ddbd');
insert into table dmf_bi.dmfbi_profits_finance_rpt_sum_s_d partition(dt='{TX_DATE}',sys_src_code='ddbd') 
    select
        etl_dt,
        dim_day,
        c1_dpt_code,

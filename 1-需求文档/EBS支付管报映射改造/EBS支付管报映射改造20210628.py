...
sql_map={
    ...
    '',
    '{TX_DATE}',
    default.getmd5('1','8106','X0000019',push.subject_manage_code,push.business_manage_code,push.business_manage_name,push.business_date,'2021-06-24',push.supplier_name,push.voucher_type_code) as uuid,

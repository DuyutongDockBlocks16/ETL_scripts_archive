...
sql_map={
    ...
    case 
    when voucher.accviewnum ='22410301' and voucher.providername like '金融-%' then '内部往来-商品销售'
    when voucher.accviewnum ='22410301' and voucher.providername like '集团-%' then '科技其他应付款-商品销售-手工'
    when voucher.accviewnum ='22410302' and voucher.providername like '金融-%' then '内部往来-服务业务'
    when voucher.accviewnum ='22410302' and voucher.providername like '集团-%' then '科技其他应付款-服务业务-手工'
    when voucher.accviewnum ='22410303' and voucher.providername like '金融-%' then '内部往来-代收代付'
    when voucher.accviewnum ='22410303' and voucher.providername like '集团-%' then '科技其他应付款-代收代付-手工' 
    when voucher.accviewnum ='22410304' and voucher.providername like '金融-%' then '内部往来-资金调拨'
    when voucher.accviewnum ='22410304' and voucher.providername like '集团-%' then '科技其他应付款-资金往来-手工'  
    when voucher.accviewnum ='22410305' then '科技其他应付款-往来业务-手工'
    else accview.ebs_name   end	    as accviewlongnum,	--	会计科目
    case 
    when voucher.accviewnum ='22410301' and voucher.providername like '金融-%' then '224301010101'
    when voucher.accviewnum ='22410301' and voucher.providername like '集团-%' then '224113010102'
    when voucher.accviewnum ='22410302' and voucher.providername like '金融-%' then '224302010101'
    when voucher.accviewnum ='22410302' and voucher.providername like '集团-%' then '224113040102'
    when voucher.accviewnum ='22410303' and voucher.providername like '金融-%' then '224303010101'
    when voucher.accviewnum ='22410303' and voucher.providername like '集团-%' then '224113030102' 
    when voucher.accviewnum ='22410304' and voucher.providername like '金融-%' then '224304010101'
    when voucher.accviewnum ='22410304' and voucher.providername like '集团-%' then '224113020102'  
    when voucher.accviewnum ='22410305' then '224113050102'
    else accview.ebs_code end       as ebs_accview_code,	--	科目编码

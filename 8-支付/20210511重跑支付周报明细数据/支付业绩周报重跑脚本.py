...
def get_customized_items():
    ...
    """ 
    today = Time.today()
#    TX_10B_DATE = date_sub('{TX_DATE}', 90)
    TX_10B_DATE = Time.date_sub(date=sql_task.get_tx_date(), itv=90)
    TX_40B_DATE = Time.date_sub(date=sql_task.get_tx_date(), itv=100)
...
sql_map={
   ...
   "sql_01": """
use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_01 ;
 create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_01
 as       
 select 
   ...
   ,sys_src
   ,card_type   
 from dmf_bc.dmfbc_oar_bc_pay_fin_stl_i_d 
 where dt>='{TX_40B_DATE}'
  and acc_date >= '{TX_10B_DATE}' 
  and acc_date<='{TX_PREDATE}'
  and flag in ('zd', 'td') 
 ;
""",
 ...
 "sql_02": """
insert into table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_01
select 
    acc_date                                                                                as dim_day_id 
   ,mer_id         
   ,trade_type      
 ...
 where dt>='{TX_40B_DATE}'
  ...
  and acc_date<='{TX_PREDATE}'
  and flag in ('df') 
  and mer_id<>'110583859001'  --20190218 yjb add;
  """,
...
select 
 ...
 where dt>='{TX_40B_DATE}'
  ...
  ; 
    ...
    "sql_05": """
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_02 ;
 create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_02
 as  
select 
    dim_day_id
   ,mer_id          
   ...
   ,sys_src 
  ,card_type   
from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_01
where pay_tools<>'白条'
union all
select 
    dim_day_id
...
where pay_tools='白条'
    ...
    "sql_06": """
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_03 ;
 create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_03
 as  
select 
    dim_day_id
   ,mer_id           
   ...
   ,sys_src
   ,card_type   
from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_02
union all 
select 
    dim_day_id
   ,mer_id           
...
and pay_tools='小金库'
    ...
    "sql_07": """
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_04 ;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_04
as  
select 
 days
...
from
    ...
    where dt>='{TX_40B_DATE}'
    and to_date(created_date)<='{TX_PREDATE}'
...
on uniorder.merchant_second_no=jhzf.third_merchant_no
 where unireorder.re_order_id is null
   ...
   where pp.days between '{TX_10B_DATE}' and '{TX_PREDATE}'
group by days
      ;
    """,
    ...
    "sql_08": """
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_05 ;
 create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_05
 as  
select
    dim_day_id 
   ,mer_id          
   ...
   ,sys_src
   ,card_type   
from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_03 p1
left join dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_04 p2 on p1.dim_day_id=p2.days
union all
select
    dim_day_id 
   ,mer_id          
   ...
   ,sys_src 
   ,card_type   
from (select *from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_03 
where dept_nm ='支付业务部' 
  and mer_ownr='体系外' 
...
left join dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_04 p2 on p1.dim_day_id=p2.days
    ...
    "sql_09": """
    use dmf_tmp;
drop table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_06 ;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_06
as 
select
    acc_date                                                                                         as dim_day_id 
...
(  --账单还款
  ...
  and to_date(payTime)<='{TX_PREDATE}'
 ...
 group by acc_date
    ...
    "sql_10": """
use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_07 ;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_07
as 
select
    dim_day_id 
   ,mer_id          
   ...
   ,sys_src
   ,card_type   
from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_05
where dept_nm='支付业务部' 
  and mer_ownr='体系内'
  and pay_tools='小金库'
union all
...
where dept_nm='支付业务部' 
  ...
  and mer_id='110646950001'
    ...
    "sql_11": """
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_08;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_08 as 
SELECT  dim_day_id,
        merchant_accept, 
...
from  
      (SELECT  t1.created_date as dim_day_id,
        ...
        FROM   (SELECT substr(created_date,1,10) as created_date,
                ...
                and substr(created_date,1,10)<='{TX_PREDATE}'
                ) t1
                join 
...
group by dim_day_id,merchant_accept
    ...
    "sql_12": """
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_09;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_09 
as 
select 
...
from (select * from odm.ODM_PAY_MERCHANT_BASE_013_S_D where dt=date_sub('{TX_DATE}',1)) a    --商户基础信息
 join dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_08 d
...
from (select * from odm.ODM_PAY_MERCHANT_BASE_013_S_D where dt=date_sub('{TX_DATE}',1)) a    --商户基础信息
 join 
    ...
    and substr(active_date,1,10)<='{TX_PREDATE}' and activation='1' ) s
    where rn=1 
...
group by e.active_date
    ...
    "sql_13": """
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_pos_my2_tradeorder;
create table dmf_tmp.temp_dyt_dmf_tmp_pos_my2_tradeorder as 
select * from (
...
;
use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_pos_my2_paymentresult;
create table dmf_tmp.temp_dyt_dmf_tmp_pos_my2_paymentresult as 
select * from (
...
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_pos_pos_fin_list;
create table dmf_tmp.temp_dyt_dmf_tmp_pos_pos_fin_list as
select 
    '建行' as bankname,
    '正向交易' as s_type,
    to_date(o.createtime) as dim_day_id,
    sum(o.trxamount) as amt
from dmf_tmp.temp_dyt_dmf_tmp_pos_my2_tradeorder o 
join dmf_tmp.temp_dyt_dmf_tmp_pos_my2_paymentresult pr on pr.payId = o.payId
where 
    o.orderSource in ('POS','POS_EXEMPT') 
    and substr(o.createtime,1,10) >='{TX_10B_DATE}'
    and substr(o.createtime,1,10)<='{TX_PREDATE}'
...
insert into table dmf_tmp.temp_dyt_dmf_tmp_pos_pos_fin_list
select 
    '农行' as bankname,
    '正向交易' as s_type,
    to_date(o.createtime) as dim_day_id,
...
where 
    ...
    and substr(createtime,1,10)<='{TX_PREDATE}'   
    and status='SUCCESS' 
...
use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_10;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_10 
as 
select      
    dim_day_id                                      as dim_day_id
   ,cast(null as string)                            as mer_id          
   ...
   ,'调整项'                                        as sys_src 
   ,cast(null as string)                            as card_type   
from  dmf_tmp.temp_dyt_dmf_tmp_pos_pos_fin_list
group by dim_day_id
    ;
    """,
    ...
    "sql_14": """
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_11;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_11
as 
select      
...
use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_12 ;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_12
as 
select date(dim_day_id) as dim_day_id,mer_id,trade_type,trade_name,product_id,pay_tools,mer_date,acc_date,order_amt,trade_amt,cast(mer_fee as double),cast(bank_fee as double),cast(trade_num as integer),flag,bus_flag,dept_nm,mer_big_type,mer_sma_type,mer_ownr,prod_type,sys_src,card_type from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_05                     --主体业务
union all                                                                                                                                             
select date(dim_day_id) as dim_day_id,mer_id,trade_type,trade_name,product_id,pay_tools,mer_date,acc_date,order_amt,trade_amt,cast(mer_fee as double),cast(bank_fee as double),cast(trade_num as integer),flag,bus_flag,dept_nm,mer_big_type,mer_sma_type,mer_ownr,prod_type,sys_src,card_type from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_06                     --白条还款
union all                                                                                                                                             
select date(dim_day_id) as dim_day_id,mer_id,trade_type,trade_name,product_id,pay_tools,mer_date,acc_date,order_amt,trade_amt,cast(mer_fee as double),cast(bank_fee as double),cast(trade_num as integer),flag,bus_flag,dept_nm,mer_big_type,mer_sma_type,mer_ownr,prod_type,sys_src,card_type from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_07                     --调减收入
union all                                                                                                                                            
select date(dim_day_id) as dim_day_id,mer_id,trade_type,trade_name,product_id,pay_tools,mer_date,acc_date,order_amt,trade_amt,cast(mer_fee as double),cast(bank_fee as double),cast(trade_num as integer),flag,bus_flag,dept_nm,mer_big_type,mer_sma_type,mer_ownr,prod_type,sys_src,card_type from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_09                     --封闭卡
union all                                                                                                                                            
select date(dim_day_id) as dim_day_id,mer_id,trade_type,trade_name,product_id,pay_tools,mer_date,acc_date,order_amt,trade_amt,cast(mer_fee as double),cast(bank_fee as double),cast(trade_num as integer),flag,bus_flag,dept_nm,mer_big_type,mer_sma_type,mer_ownr,prod_type,sys_src,card_type from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_10                     --调整项POS
union all                                                                                                                                           
select date(dim_day_id) as dim_day_id,mer_id,trade_type,trade_name,product_id,pay_tools,mer_date,acc_date,order_amt,trade_amt,cast(mer_fee as double),cast(bank_fee as double),cast(trade_num as integer),flag,bus_flag,dept_nm,mer_big_type,mer_sma_type,mer_ownr,prod_type,sys_src,card_type from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_11                     --线下导入数据 POP结算、TO-C运营、利息收入
;
    """,
    ...
    "sql_16": """ 
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_13 ;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_13
as
select 
   dim_day_id                                  --统计日期维度
  ,mer_id                                      --二级商户号id
  ...
  ,dim_day_id                 as dt
from 
dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_12
where 1=1
and dim_day_id>='{TX_10B_DATE}'
and dim_day_id<='{TX_PREDATE}'
group by 
 dim_day_id  
,mer_id      
,trade_type  
...
,case when card_type='CR' then '贷记卡' 
    ...
    "sql_17": """ 
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_14 ;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_14
as
select 
...
from idm.idm_f02_fin_xjk_tx_dtl_s_d
  where dt='{TX_PREDATE}'
    ...
    and substr(ordr_time,1,10)<='{TX_PREDATE}'
...
;
    """,
     ...
     use dmf_tmp;
------拆分消费金融 白条、金条还款额占比
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_15;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_15
as 
--白条还款表
select 
...
where dt='{TX_PREDATE}'
and substr(pay_time,1,10)<='{TX_PREDATE}'
...
where dt='{TX_PREDATE}'
 and to_date(createdate)<='{TX_PREDATE}' 
...
use dmf_tmp;
------拆分消费金融 白条、金条还款额占比
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_151;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_151
as 
select 
     tt.repay_date 
 ...
 from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_15 tt
 ...
 ;
    ...
    "sql_19": """    
    use dmf_tmp;
drop table if exists dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_16;
create table dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_16
as 
select 
   dim_day_id                                  --统计日期维度
  ,mer_id                                      --二级商户号id
  ...
  ,dt                                          --时间分区  
from 
dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_13
...
select 
  ...
  ,dt                                               --时间分区  
from 
(select *from dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_13
where mer_sma_type='白条还款') t1
left join dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_151 t2 
...
select 
  ...
  ,dt
from 
dmf_tmp.temp_dyt_dmf_tmp_dmfbc_oar_bc_pay_sis_fin_rpt_i_d_16
group by 
 dim_day_id  
,mer_id      
,trade_type  

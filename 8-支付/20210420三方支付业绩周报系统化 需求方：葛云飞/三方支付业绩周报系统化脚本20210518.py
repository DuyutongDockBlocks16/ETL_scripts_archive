...
sql_map={
    ...
    "sql_01": """
     use dmf_tmp;
    drop table dmf_tmp.dmcbc_bc_pay_pay_rpt_i_d_1_new_zh ;
    create table dmf_tmp.dmcbc_bc_pay_pay_rpt_i_d_1_new_zh as
    select
  dt as da_te,
  trade_name,
  product_id,
...
group by
  ...
  prod_type 
    ...
    "sql_02": """
    use dmf_tmp;
    drop table dmf_tmp.dmcbc_bc_pay_pay_rpt_i_d_2_new_zh ;
    create table dmf_tmp.dmcbc_bc_pay_pay_rpt_i_d_2_new_zh as
    select
    a.*,
    ...
    "sql_03": """
    use dmf_tmp;
    drop table dmf_tmp.dmcbc_bc_pay_pay_rpt_i_d_3_new_zh;
    create table dmf_tmp.dmcbc_bc_pay_pay_rpt_i_d_3_new_zh as
    select
    a.*,

...
sql_map={
    ...
    "sql_05": """
	use dmf_tmp;
    drop table if exists dmf_tmp.tmp_jcw_dmfbi_profits_pay_qyzf_corp_week_rpt_s_d_dyt_detail_003;
	;
    """,
    
    "sql_06": """
    use dmf_tmp;---首先加工明细层，为列传行做准备
    create table if not exists dmf_tmp.tmp_jcw_dmfbi_profits_pay_qyzf_corp_week_rpt_s_d_dyt_detail_003 
    as  
    ...
    policy_type
    from dmf_tmp.tmp_jcw_dmfbi_profits_pay_qyzf_corp_week_rpt_s_d_dyt_detail_002
    ...
    select 
    *
    from dmf_tmp.tmp_jcw_dmfbi_profits_pay_qyzf_corp_week_rpt_s_d_dyt_detail_003 
    ;
    """,    

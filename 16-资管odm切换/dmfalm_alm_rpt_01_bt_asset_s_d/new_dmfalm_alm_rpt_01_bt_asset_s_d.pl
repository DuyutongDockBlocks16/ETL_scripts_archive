...
SELECT
    ...
    FROM
        (SELECT CASE INVESTOR_ID 
           ...
           FROM odm.ODM_AM_ABS_INVESTOR_LOAN_0000_S_D  B -----odm.ODM_FI_INVESTOR_LOAN_S_D  B  
          WHERE B.DT = '$TX_DATE' 
    ...
    LEFT JOIN
        (SELECT CASE INVESTOR_ID 
           ...
           FROM (SELECT * FROM odm.ODM_AM_ABS_INVESTOR_FLOW_0000_S_D  A -----odm.ODM_FI_INVESTOR_FLOW_S_D A 
                  WHERE A.DT = '$TX_DATE' 
